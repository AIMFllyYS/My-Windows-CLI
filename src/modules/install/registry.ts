...
export const ENV_INSTALL_TARGETS: InstallTarget[] = [
  {
    key: 'proxy',
    displayName: 'Sibker 代理环境',
    category: 'environment',
    aliases: ['magic', 'magic-env', 'sibker', 'vpn'],
    description: '给新手准备的外网访问入口：注册后购买套餐，复制通用订阅链接，再导入 Clash Verge。',
    sourceUrl: 'https://www.sibker.com/register?invite_code=LOO3ipxE',
    installUrl: 'https://www.sibker.com/register?invite_code=LOO3ipxE',
    requirements: [],
    commands: [],
    opensUrlOnly: true,
    notes: '提示：代理服务通常是付费服务。配置完成后优先使用规则模式；只有确实需要全部流量走代理时再开全局代理。',
  },
  {
    key: 'clash-verge',
    displayName: 'Clash Verge - Windows',
    category: 'environment',
    aliases: ['clash', 'clash-verge-windows', 'clash-verge-win'],
    description: 'Windows 版代理客户端，用来导入 Sibker 等服务提供的订阅链接，并开启规则代理或 TUN 模式。',
  ...
  {
    key: 'clash-verge-mac-intel',
    displayName: 'Clash Verge - macOS Intel',
    category: 'environment',
    aliases: ['clash-mac-intel', 'clash-verge-intel'],
    description: 'macOS Intel 芯片版代理客户端，适合老款 Intel Mac。',
    sourceUrl: 'https://www.sibker.com/client/Clash.Verge_2.4.7_x64.dmg',
    installUrl: 'https://www.sibker.com/client/Clash.Verge_2.4.7_x64.dmg',
    requirements: [],
    commands: [],
    opensUrlOnly: true,
  },
  {
    key: 'clash-verge-mac-arm',
    displayName: 'Clash Verge - macOS Apple Silicon',
    category: 'environment',
    aliases: ['clash-mac-arm', 'clash-verge-arm', 'clash-verge-m-chip'],
    description: 'macOS M 系列芯片版代理客户端，适合 M1/M2/M3/M4 Mac。',
    sourceUrl: 'https://www.sibker.com/client/Clash.Verge_2.4.7_aarch64.dmg',
    installUrl: 'https://www.sibker.com/client/Clash.Verge_2.4.7_aarch64.dmg',
    requirements: [],
    commands: [],
    opensUrlOnly: true,
  },
  {
    ...
    category: 'environment',
    aliases: ['ccswitch', 'claude-switch', 'claude-code-switch'],
    description: 'Claude Code 模型供应商切换工具，适合在 Claude Code 中接入 GLM、Kimi、DeepSeek 等其他 API。',
    sourceUrl: 'https://github.com/farion1231/cc-switch',
    installUrl: 'https://github.com/farion1231/cc-switch/releases/download/v3.16.2/CC-Switch-v3.16.2-Windows.msi',
    requirements: [],
    commands: [
      { platform: 'win32', command: "powershell -NoProfile -ExecutionPolicy Bypass -Command \"Start-Process 'https://github.com/farion1231/cc-switch/releases/download/v3.16.2/CC-Switch-v3.16.2-Windows.msi'\"" },
      { platform: 'darwin', command: 'open "https://github.com/farion1231/cc-switch/releases/download/v3.16.2/CC-Switch-v3.16.2-macOS.dmg"' },
    ],
    notes: 'Windows 会打开 MSI 下载链接；macOS 会打开 DMG 下载链接。安装后在 CC Switch 中添加供应商、填 API Key，再切换 Claude Code 使用的模型配置。',
  },
  {
    key: 'cc-switch-mac',
    displayName: 'CC Switch - macOS',
    category: 'environment',
    aliases: ['ccswitch-mac', 'claude-switch-mac'],
    description: 'CC Switch macOS 版直接下载入口，适合 Mac 用户手动下载 DMG 安装包。',
    sourceUrl: 'https://github.com/farion1231/cc-switch/releases/download/v3.16.2/CC-Switch-v3.16.2-macOS.dmg',
    installUrl: 'https://github.com/farion1231/cc-switch/releases/download/v3.16.2/CC-Switch-v3.16.2-macOS.dmg',
    requirements: [],
    commands: [],
    opensUrlOnly: true,
  },
  {
    key: 'virtual-card',
    displayName: 'SupayCard 虚拟卡',
    category: 'environment',
    aliases: ['supaycard', 'card', 'supay'],
    description: '用于海外订阅和开发者平台绑卡的虚拟卡入口，新手请先确认费用、风控和用途。',
    sourceUrl: 'https://www.supaycard.com/landingView?ref=vggONf',
    installUrl: 'https://www.supaycard.com/landingView?ref=vggONf',
    requirements: [],
    commands: [],
    opensUrlOnly: true,
  },
  {
    key: 'fingerprint-browser',
    displayName: 'AdsPower 指纹浏览器',
    category: 'environment',
    aliases: ['adspower', 'browser'],
    description: '多账号隔离和浏览器环境管理工具，新手一般不是第一步必须安装。',
    sourceUrl: 'https://www.adspower.net/share/NbSkYx',
    installUrl: 'https://www.adspower.net/share/NbSkYx',
    requirements: [],
    commands: [],
    opensUrlOnly: true,
  },
